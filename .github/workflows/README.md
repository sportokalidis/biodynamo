...
installation. System CI installs the exact checked-out revision in a temporary
clone, removes that clone, then tests the installed distribution as well as the
build-tree demos and Valgrind targets. This also works for fork branches.
