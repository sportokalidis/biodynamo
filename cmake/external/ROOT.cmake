...
if(APPLE)
  if("${DETECTED_OS_VERS}" MATCHES "^osx-26" OR
    ...
    if ("${XCODE_VERS}" GREATER_EQUAL "26.1")
      message(STATUS "##### Using ROOT builds for XCODE 26.1")
      set(ROOT_TAR_FILE root_v6.36.06_cxx17_python3.9_osx-xcode-26.1-${DETECTED_ARCH}.tar.gz)
      set(ROOT_SHA_KEY osx-xcode-26.1-${DETECTED_ARCH}-ROOT)
    elseif ("${XCODE_VERS}" GREATER_EQUAL "26.0")
      message(STATUS "##### Using ROOT builds for XCODE 26.0")
      set(ROOT_TAR_FILE root_v6.36.06_cxx17_python3.9_osx-xcode-26.0-${DETECTED_ARCH}.tar.gz)
